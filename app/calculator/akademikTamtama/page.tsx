...
const AkademikTamtama = () => {
  ...
  const handleCalculate = () => {
    ...
    const numericsScore = (parseFloat(scores.numerics) || 0) * 0.25;
    const languageScore = (parseFloat(scores.language) || 0) * 0.25;
        ...
        <form className="p-6 pt-0 grid gap-4 w-full" onSubmit={(e) => { e.preventDefault(); handleCalculate(); }}>
          ...
          <div className="grid gap-2">
            <label htmlFor="language" className="block text-sm font-medium leading-none text-zinc-950">
              Nilai Bhs. Inggris <span className='text-red-500'>*</span>
            </label>
            <input
              type="number"
              name="language"
              placeholder="Masukan nilai bhs. inggris"
              className="h-10 w-full border rounded-md px-3 py-2 text-sm outline-none placeholder:text-zinc-500 focus:border-zinc-900 shadow-sm"
          ...
          <div>
            ...
            <div className='flex flex-col gap-4 p-6'>
              ...
              <div>
                ...
                <p>Nilai Penalaran Numerik (25%) : {result.numericsScore.toFixed(1)}</p>
                <p>Nilai Bhs. Inggris (25%) : {result.languageScore.toFixed(1)}</p>
              </div>
            </div>
...
export default AkademikTamtama;
